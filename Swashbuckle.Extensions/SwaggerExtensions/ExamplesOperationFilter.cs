...
#pragma warning disable 1591
    ...
    public class ExamplesOperationFilter : IOperationFilter
    {
        ...
        {
            var jsonString = JsonConvert.SerializeObject(examples, new JsonSerializerSettings { ContractResolver = new Newtonsoft.Json.Serialization.CamelCasePropertyNamesContractResolver() });
