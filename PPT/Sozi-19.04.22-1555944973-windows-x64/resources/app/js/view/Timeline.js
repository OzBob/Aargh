...
Timeline.repaint = function () {
    ...
    var topLeft = this.container.querySelector(".timeline-top-left");
    var topRight = this.container.querySelector(".timeline-top-right");
    var bottomLeft = this.container.querySelector(".timeline-bottom-left");
    var bottomRight = this.container.querySelector(".timeline-bottom-right");
    ...
    var rightWidth = this.container.clientWidth - leftWidth;
    var topHeight = Math.max(topLeftTable.clientHeight, topRightTable.clientHeight);
    var bottomHeight = this.container.clientHeight - topHeight;
...
Timeline.render = function () {
    ...
    return (0, _infernoHyperscript.h)("div", [(0, _infernoHyperscript.h)("div.timeline-top-left", [(0, _infernoHyperscript.h)("table.timeline", [(0, _infernoHyperscript.h)("tr", [(0, _infernoHyperscript.h)("th", [(0, _infernoHyperscript.h)("button", {
        title: _("Delete the selected frames"),
        disabled: this.selection.selectedFrames.length ? undefined : "disabled",
        onclick: function onclick() {
            c.deleteFrames();
        }
    }, (0, _infernoHyperscript.h)("i.fas.fa-trash"))]), (0, _infernoHyperscript.h)("th", [(0, _infernoHyperscript.h)("button", {
        title: _("Create a new frame"),
        onclick: function onclick() {
            c.addFrame();
        }
    }, (0, _infernoHyperscript.h)("i.fas.fa-plus"))])]), (0, _infernoHyperscript.h)("tr", [(0, _infernoHyperscript.h)("th", { colspan: 2 }, (0, _infernoHyperscript.h)("select", {
        onchange: function onchange(evt) {
            var value = evt.target.value;
            evt.target.value = "__add__";
            _this5.addLayer(value);
        }
    }, [(0, _infernoHyperscript.h)("option", { value: "__add__", selected: "selected" }, _("Add layer")), this.presentation.layers.slice().reverse().filter(function (layer) {
        return !layer.auto && _this5.defaultLayers.indexOf(layer) >= 0;
    }).map(function (layer) {
        return (0, _infernoHyperscript.h)("option", { value: layer.index }, layer.label);
    })]))])])]), (0, _infernoHyperscript.h)("div.timeline-bottom-left", [(0, _infernoHyperscript.h)("table.timeline", [this.hasDefaultLayer ? (0, _infernoHyperscript.h)("tr", [(0, _infernoHyperscript.h)("th.layer-icons", [defaultLayersAreVisible ? (0, _infernoHyperscript.h)("i.visibility.far.fa-eye", {
        title: _("This layer is visible. Click to hide it."),
        onclick: function onclick(evt) {
            return _this5.toggleLayerVisibility(-1, evt);
        }
    }) : (0, _infernoHyperscript.h)("i.visibility.far.fa-eye-slash", {
        title: _("This layer is hidden. Click to show it."),
        onclick: function onclick(evt) {
            return _this5.toggleLayerVisibility(-1, evt);
        }
    }), (0, _infernoHyperscript.h)("i.remove.fas.fa-times", { style: { visibility: "hidden" } })]), (0, _infernoHyperscript.h)("th", {
        className: "layer-label" + (this.defaultLayersAreSelected ? " selected" : ""),
        onclick: function onclick(evt) {
            return _this5.updateLayerSelection(-1, evt);
        }
    }, _("Default"))]) : null, this.presentation.layers.slice().reverse().filter(function (layer) {
        return _this5.editableLayers.indexOf(layer) >= 0;
    }).map(function (layer) {
        return (0, _infernoHyperscript.h)("tr", [(0, _infernoHyperscript.h)("th.layer-icons", [layer.isVisible ? (0, _infernoHyperscript.h)("i.visibility.far.fa-eye", {
            title: _("This layer is visible. Click to hide it."),
            onclick: function onclick(evt) {
        ...
        }), (0, _infernoHyperscript.h)("i.remove.fas.fa-times", {
            title: _("Remove this layer"),
            onclick: function onclick() {
                return _this5.removeLayer(layer.index);
            }
        })]), (0, _infernoHyperscript.h)("th", {
    ...
    }), (0, _infernoHyperscript.h)("tr", { style: { visibility: "collapse" } }, [(0, _infernoHyperscript.h)("th.layer-icons"), (0, _infernoHyperscript.h)("th.layer-label", _("Default"))])])]), (0, _infernoHyperscript.h)("div.timeline-top-right", [(0, _infernoHyperscript.h)("table.timeline", [(0, _infernoHyperscript.h)("tr", this.presentation.frames.map(function (frame, frameIndex) {
        return (0, _infernoHyperscript.h)("th", {
        ...
        }, [(0, _infernoHyperscript.h)("i.insert-before.fas.fa-arrow-circle-down", {
            title: _jed2.default.sprintf(_("Insert selection before frame %d"), frameIndex + 1),
            onclick: function onclick(evt) {
                c.moveFrames(frameIndex);
                evt.stopPropagation();
            }
        }), (0, _infernoHyperscript.h)("i.insert-after.fas.fa-arrow-circle-down", {
    ...
    })), (0, _infernoHyperscript.h)("tr", this.presentation.frames.map(function (frame, frameIndex) {
        return (0, _infernoHyperscript.h)("th", {
            title: frame.title,
    ...
    }))])]), (0, _infernoHyperscript.h)("div.timeline-bottom-right", {
        onscroll: function onscroll(evt) {
            _this5.container.querySelector(".timeline-top-right").scrollLeft = evt.target.scrollLeft;
            _this5.container.querySelector(".timeline-bottom-left").scrollTop = evt.target.scrollTop;
        }
    }, (0, _infernoHyperscript.h)("table.timeline", [this.hasDefaultLayer ? (0, _infernoHyperscript.h)("tr", this.presentation.frames.map(function (frame, frameIndex) {
        return (0, _infernoHyperscript.h)("td", {
            className: (_this5.defaultLayersAreSelected && _this5.selection.selectedFrames.indexOf(frame) >= 0 ? "selected" : "") + (frame === _this5.selection.currentFrame ? " current" : "") + (frameIndex > 0 && frame.layerProperties[_this5.defaultLayers[0].index].link ? " link" : "") + (updateEven(frame, _this5.defaultLayers[0]) ? " even" : " odd"),
            onclick: function onclick(evt) {
                return _this5.updateLayerAndFrameSelection(-1, frameIndex, evt);
            }
        });
    })) : null, this.presentation.layers.slice().reverse().filter(function (layer) {
        return _this5.editableLayers.indexOf(layer) >= 0;
    }).map(function (layer) {
        return (0, _infernoHyperscript.h)("tr", _this5.presentation.frames.map(function (frame, frameIndex) {
            return (0, _infernoHyperscript.h)("td", {
                className: (_this5.selection.selectedLayers.indexOf(layer) >= 0 && _this5.selection.selectedFrames.indexOf(frame) >= 0 ? "selected" : "") + (frame === _this5.selection.currentFrame ? " current" : "") + (frameIndex > 0 && frame.layerProperties[layer.index].link ? " link" : "") + (updateEven(frame, layer) ? " even" : " odd"),
                onclick: function onclick(evt) {
                    return _this5.updateLayerAndFrameSelection(layer.index, frameIndex, evt);
                }
            });
        }));
    }), (0, _infernoHyperscript.h)("tr.collapse", this.presentation.frames.map(function (frame) {
        return (0, _infernoHyperscript.h)("td", frame.title);
    }))]))]);
};
